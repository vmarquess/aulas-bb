Dockerfile para criação de um container apache e lista de comandos para build da imagem e execução do container, além de subir a imagem para o docker hub.
